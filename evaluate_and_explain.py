...
def run_academic_validation():
    print("="*80)
    print(" 📊 BatteryChem-AI: Balanced Multi-Polyphenol Validation Pipeline 📊")
    print("="*80)
    
    X, Y_physical = load_pure_large_scale_physical_dataset()
    if X is None or len(X) == 0: return
    y_physical_cond = Y_physical[:, 0]
    ...
    plt.title('Balanced Multi-Polyphenol Scale Performance')
